...
## Content
  ...
  4. [Logical instruction](logical-intructions.md)
  5. [Load Effective Address](load-effective-address.md)
  6. [Operator Pointer](operator-pointer.md)
  7. [Interrupt](interupt.md)
